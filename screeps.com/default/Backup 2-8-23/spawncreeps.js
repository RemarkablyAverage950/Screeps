...
function spawnCreeps(room, creeps, spawns) {
    ...
    const maxCount = Math.max(workers, fillers, upgraders, miners, builders, haulers, soldiers, healers, scouts, remoteMiners, remoteWorkers, remoteHaulers, reservers, claimers, hubCreeps, wallBuilders, maintainers) + 1
    ...
    for (let spawn of availableSpawns) {
        ...
        for (let j = 0; j <= maxCount; j++) {
            ...
            if (workers < targets.targetWorkerCount) {
            ...
            } else if (builders < targets.targetBuilderCount && builders < j) {
            ...
            } else if (maintainers < targets.targetMaintainerCount && maintainers < j) {
                ...
                for (let i = 0; i < targets.targetMaintainerCount; i++) {
            ...
            for (let i = 0; i < targetHealerCount; i++) {
        ...
        } */else if (wallBuilders < targets.targetWallBuilderCount && wallBuilders < j) {
            ...
            } else if (upgraders < targets.targetUpgraderCount && upgraders < j) {
            ...
            } else if (haulers < targets.targetHaulerCount && haulers < j) {
            ...
            } else if (hubCreeps < targets.targetHubCount && hubCreeps < j) {
                ...
                for (let i = 0; i < targets.targetSoldierCount + 2; i++) {
            ...
            } else if (scouts < targets.targetScoutCount && scouts < j) {
            ...
            } else if (remoteWorkers < targets.targetRemoteWorkerCount && remoteWorkers < j) {
            ...
            else if (remoteMiners < targets.targetRemoteMinerCount && remoteMiners < j) {
            ...
            } else if (remoteHaulers < targets.targetRemoteHaulerCount && remoteHaulers < j) {
            ...
            } else if (claimers < targets.targetClaimerCount && claimers < j) {
            ...
            } else if (reservers < targets.targetReserverCount && reservers < j && maxSpawnEnergy >= 1300) {
...
function initializeRoomData(room, miners, fillers) {
    ...
    targetCounts[room.name] = {
        ...
        targetFillerCount: getTargetFillerCount(room),
        ...
        targetMaintainerCount: getTargetMaintainerCount(room),
    }
}
