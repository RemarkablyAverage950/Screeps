...
[4, -3], [4, -2], [5, -1], [5, -2], [5, -3], [6, -2], [-2, 0], [-3, 0], [-3, 1], [-3, -1],
[-3, -3], [-3, -4], [-3, -5], [-2, -5], [-2, -4], [-1, -5], [-4, -2], [-4, 2], [0, -6], [4, -6]]
...
function buildControllerStructures(room, spawn) {
    ...
    if (controllerLinks.length > 0 && controllerContainers.length > 0) {
        console.log('remove controller container')
        ...
        if (controllerLinks.length == 0 && availableLinks > 0) {
            ...
            room.createConstructionSite(path[2].x, path[2].y, STRUCTURE_LINK)
            return true
