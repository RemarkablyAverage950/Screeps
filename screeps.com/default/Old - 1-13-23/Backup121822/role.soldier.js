...
var roleSoldier = {
    ...
    run: function (creep) {
        ...
        /*for (let spawn in Game.spawns) {
            if (Game.spawns[spawn].memory.home == creep.memory.home && Game.spawns[spawn].memory.hostile_room != undefined) {
                targetRoom = Game.spawns[spawn].memory.hostile_room
            } else {
        ...
        if (creep.room.name != targetRoom) {
            ...
            if (hostiles.length > 0) {
                ...
                for (let spawn in Game.spawns) {
                    //console.log(spawn)
                    if (Game.spawns[spawn].memory.home == creep.memory.home && Game.spawns[spawn].memory.hostile_room == creep.room.name) {
                        console.log('Hostile Killed')
...
// Game.spawns['Spawn1'].memory.hostile_room = 'W6S28'
// delete Game.spawns['Spawn1'].memory.hostile_room