...
function taskManagerOld(room, roomCreeps) {
    ...
    let taskNeedingCreeps = roomCreeps.filter(c => c.memory.needTask == true && (c.memory.role == 'worker' || c.memory.role == 'transporter' || c.memory.role == 'miner' || c.memory.role == 'upgrader'))
