...
function taskManager(room, roomCreeps) {
    ...
    let taskNeedingCreeps = roomCreeps.filter(c => c.memory.needTask == true && c.memory.role != 'scout' && c.memory.role != 'remoteMiner' && c.memory.role != 'remoteWorker' && c.memory.role != 'remoteTransporter')
