...
Source.prototype.assignedCreeps = function () {
    ...
    return Object.values(Game.creeps).filter(c => {
        ...
        if (creepTasks[c.memory.home] && creepTasks[c.memory.home][c.name] && creepTasks[c.memory.home][c.name].task && creepTasks[c.memory.home][c.name].task.target == this.id) {
            return true
        } else if (creepTasks[c.memory.home] && creepTasks[c.memory.home][c.name] && creepTasks[c.memory.home][c.name].taskQueue) {
...
Mineral.prototype.assignedCreeps = function () {
    return Object.values(Game.creeps).filter(c => {
...
Tombstone.prototype.assignedCreeps = function () {
    return Object.values(Game.creeps).filter(c => {
        if (!creepTasks[c.memory.home] || !creepTasks[c.memory.home][c.name] || !creepTasks[c.memory.home][c.name].task) {
            return false
        }
...
Tombstone.prototype.forecast = function (resource) {
    if (!this.store) {
