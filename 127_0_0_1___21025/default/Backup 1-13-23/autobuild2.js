...
const mapRamparts = require('ramparts')
...
function mapExtensions(tiles, center, round) {
    const BUILDINGS = [
        [0, -2, STRUCTURE_ROAD, 2],
        [-1, -1, STRUCTURE_ROAD, 2],
        [0, -1, STRUCTURE_EXTENSION, 1],
        [1, -1, STRUCTURE_ROAD, 2],
        [-2, 0, STRUCTURE_ROAD, 2],
        [-1, 0, STRUCTURE_EXTENSION, 1],
        [0, 0, STRUCTURE_EXTENSION, 1],
        [1, 0, STRUCTURE_EXTENSION, 1],
        [2, 0, STRUCTURE_ROAD, 2],
        [-1, 1, STRUCTURE_ROAD, 2],
        [0, 1, STRUCTURE_EXTENSION, 1],
    ...
    BUILDINGS.forEach(b => {
        const isCenter = (b[0] == 0 && b[1] == 0)
        updateTile(centerX + b[0], centerY + b[1], b[2], tiles, isCenter, b[3], roundRCL[round])
    })
}
